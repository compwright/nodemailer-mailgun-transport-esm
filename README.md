...
============================
[![Known Vulnerabilities](https://snyk.io/test/github/compwright/nodemailer-mailgun-transport-esm/badge.svg)](https://snyk.io/test/github/compwright/nodemailer-mailgun-transport-esm)
...
import mg from 'nodemailer-mailgun-transport-esm';
...
```bash
npm install --save nodemailer nodemailer-mailgun-transport-esm
```
